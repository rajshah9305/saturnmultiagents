...
export const Palette: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M14 10a2 2 0 1 0 4 0 2 2 0 0 0-4 0" />
...
export const Brain: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M12 2a4.5 4.5 0 0 0-4.5 4.5c0 1.05.38 2.02.99 2.82V12a2.5 2.5 0 0 0-2.5 2.5v1.42c-1.15.54-2 1.72-2 3.08a3 3 0 0 0 3 3h11a3 3 0 0 0 3-3c0-1.36-.85-2.54-2-3.08V14.5a2.5 2.5 0 0 0-2.5-2.5v-2.68c.6-.8 1-1.77 1-2.82A4.5 4.5 0 0 0 12 2Z" />
    <path d="M12 12v2.5" />
    <path d="M15.5 14.5a2.5 2.5 0 0 0-5 0V16" />
  </svg>
);
...
export const Cpu: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M15 12h5"></path><path d="M4 12h5"></path>
  </svg>
);
...
export const Lightbulb: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M9 18h6" />
    <path d="M10 22h4" />
    <path d="M12 2a7 7 0 0 0-7 7c0 3.04 1.63 5.36 4 6.5V20h6v-4.5c2.37-1.14 4-3.46 4-6.5a7 7 0 0 0-7-7Z" />
  </svg>
);
